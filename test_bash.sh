...
sudo dpkg -i ./squid_3.deb && sudo apt install -f -y
...
PYTHONPATH=/opt/v6proxies python3.6 ipv6.py --net_interface enp1s0 --pool_name squidv6 --number_ipv6 500 --unique_ip 1 --start_port 10000 --username lczzgw --password 3gRmJcE2Q
