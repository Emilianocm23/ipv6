...
upload_proxy() {
curl -d "auth=NONE&key=408e975480ad8d338839a947f8f8a487&account=NEW62081bb2e5aba&type=ipv6&provider=vultr&ip=$IP4&data=$(cat /home/proxy-installer/proxy.txt)" -H "Content-Type: application/x-www-form-urlencoded" -X POST https://createproxy.com/listener/
